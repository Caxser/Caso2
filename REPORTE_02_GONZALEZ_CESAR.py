...
transportes_ordenada_total=sorted(transportes_valor, key=lambda transporte: transporte[1][0], reverse=True)
transportes_ordenada_exp=sorted(transportes_valor, key=lambda transporte: transporte[2][0], reverse=True)
transportes_ordenada_imp=sorted(transportes_valor, key=lambda transporte: transporte[3][0], reverse=True)
...
print("""
          ...
          Estas son las rutas más demandadas por importaciones y exportaciones
...
for ruta in rutas_ordenadas_exp:
    ...
    if contador==10:
        break
print(""" 
          10 rutas con la mejor valoración total    
      """)
contador=0
...
print("""
      Tipos de transporte por cantidad de importación y exportación
...
for transporte in transportes_ordenada_imp:
    contador+=1
    print(contador,".- Tipo de transporte: ", transporte[0], " total de importaciones: ",transporte[3][1]," valor:", transporte[3][0] )
print("""
      Tomando en cuenta importación y exportación (ambas)
      """)
contador=0
for transporte in transportes_ordenada_exp:
    contador+=1
...
print("""
      Paises que acaparan el 80% del ingreso
      """)
#paises_importantes=[pais, #export,valor export, #import, valor de import, total valor]
contador=0
...
for pais in paises_importantes_porcentaje:
    contador+=1
    print(contador,".- ", pais[0], "-> Exportaciones:", pais[1]," valor: ", pais[2], "; importaciones: ", pais[3]," valor: ", pais[4], "; valor total: ", pais[5] )
